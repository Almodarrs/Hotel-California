...
<head>
    ...
    <!-- Morris Chart Styles-->
    <link href="public/morris-0.4.3.min.css" rel="stylesheet" />
    <!-- Custom Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="changepr.php"><i class="fa fa-qrcode"></i> Change Price</a>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    $tsql_stmt = $pdo->query($tsql);
                                    
                                    while($trow =  $tsql_stmt->fetch(PDO::FETCH_BOTH))
                                    //foreach($trow as $re_tsql):
									{	
										$co =$trow['confirmation']; 
										if($co=="Not Conform")
										{
											echo"<tr>
												<th>".$trow['id'] ."</th>
												<th>".$trow['f_name']." ".$trow['l_name']."</th>
												<th>".$trow['email']."</th>
												<th>".$trow['country']."</th>
												<th>".$trow['room_category']."</th>
												
												
												<th>".$trow['start']."</th>
												<th>".$trow['end']."</th>
												<th>".$trow['confirmation']."</th>
                      ...
                      <!-- End  Basic Table  --> 
								...
								$rre = $pdo->query($rsql); 
								$r =0;
								while($row= $rre->fetch(PDO::FETCH_BOTH) )
								{		
										$br = $row['confirmation'];
										if($br=="Conform")
										{
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
                                        <div class="panel-body">
										<?php
										$msql = "SELECT * FROM `reservations`";
										$mre = $pdo->query($msql);
										
										while($mrow= $mre->fetch(PDO::FETCH_BOTH) )
										{		
											$br = $mrow['confirmation'];
											if($br=="Conform")
											{
												$fid = $mrow['id'];
